...
def plot_roc(nR_S1=None, nR_S2=None, fitModel=None, ax=None):
    ...
    if fitModel is None:
        ...
        ax[0].plot(fitModel['obs_FAR2_rS1'], fitModel['obs_HR2_rS1'], 'ko-',
                   linewidth=1.5, markersize=12, label='Observed')
        ax[0].plot(fitModel['est_FAR2_rS1'], fitModel['est_HR2_rS1'], 'bo-',
                   linewidth=1.5, markersize=6, label='Estimated')
        ...
        ax[1].plot(fitModel['obs_FAR2_rS2'], fitModel['obs_HR2_rS2'], 'ko-',
                   linewidth=1.5, markersize=12, label='Observed')
        ax[1].plot(fitModel['est_FAR2_rS2'], fitModel['est_HR2_rS2'], 'bo-',
                   linewidth=1.5, markersize=6, label='Estimated')
